...
\begin{itemize}
	\item Sättigungsgrad als Anteil der Datenpunkte in der Sättigung des ADC %Gl.~\ref{eq:dist_sat}, Kurtosis %aus Gl.~\ref{eq:kurtosis} 
